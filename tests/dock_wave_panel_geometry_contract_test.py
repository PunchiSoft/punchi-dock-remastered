...
require(
    ...
    and "inPanel && !customThemeActiveInPanel" in CONFIG_MOUSE
    and 'i18n("At 0%, the hover enlargement animation is disabled.")'
    in CONFIG_MOUSE
    and 'i18n("Plasma panels limit hover enlargement to 65%' in CONFIG_MOUSE,
    "Hover enlargement must describe the adaptive Plasma panel limit.",
)
require(
